...
function addData(){
    ...
    localStorage.setItem("localdeptData",JSON.stringify(arr));
    showData();
    getData();
...
function getData(){
    var str= localStorage.getItem("localdeptData");
    if(str!=null){
        arr= JSON.parse(str);
    }
    else{
...
var arr= JSON.parse(localStorage.getItem("localdeptData"));
...
document.getElementById("employeelist").innerHTML=` <caption><h3>Department</h3><caption><br>
<input type="text" id="myInput" placeholder="Search by Name ......." onkeyup="searchFun('data2')" size="115">
